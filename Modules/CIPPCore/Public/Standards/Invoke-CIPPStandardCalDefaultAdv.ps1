function Invoke-CIPPStandardCalDefaultAdv {
    <#
    .FUNCTIONALITY
        Internal
    .COMPONENT
        (APIName) CalDefaultAdv
    .SYNOPSIS
        (Label) Set Sharing Level for Default calendar (Advanced)
    .DESCRIPTION
        (Helptext) Sets the default sharing level for the default calendar, for all users or a specified group name.
        (DocsDescription) Sets the default sharing level for the default calendar for all users or a specified in the tenant. You can read about the different sharing levels [here.](https://learn.microsoft.com/en-us/powershell/module/exchange/set-mailboxfolderpermission?view=exchange-ps#-accessrights)
    .NOTES
        CAT
            Exchange Standards
        TAG
